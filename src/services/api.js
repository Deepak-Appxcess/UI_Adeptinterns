...
const api = axios.create({
  baseURL: 'https://joe-unified-florence-dk.trycloudflare.com/api',
...
export const fetchInternshipDetails = (id) => api.get(`/jobs/${id}/`);
// In services/api.js
...
export const updateApplicationStatus = (applicationId, data) => {
  return api.patch(`/jobs/employer/applications/${applicationId}/status/`, data);
};
